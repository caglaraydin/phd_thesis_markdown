...
% Sections
\cftsetindents{chapter}{0pc}{4pc}
\cftsetindents{section}{0pc}{4pc}
\cftsetindents{subsection}{0pc}{4pc}
\cftsetindents{subsubsection}{0pc}{4pc}
\cftsetindents{figure}{0pc}{60pt}
\cftsetindents{table}{0pc}{60pt}

% Chapter kısmının ayarları
\setlength{\cftbeforechapskip}{0pt} % Chapter lar arasındaki dikey boşluğu kaldırmak için.
...
% Ara boşluklardaki noktalar arası mesafeyi ayarlamak için
